...
export const CreateContentScreen: React.FC = () => {
  ...
  const [selectedBoardType, setSelectedBoardType] = useState(BoardTypeList[0]);
  ...
  const handleSubmit = () => {
    ...
    try {
      ...
      setSnackbarMessage('게시글이 작성되었습니다.');
      setSnackbarVisible(true);
      setTimeout(() => navigation.goBack(), 1000);
    } catch (e) {
      console.log(e);
      setSnackbarMessage('게시글 작성에 실패했습니다.');
      setSnackbarVisible(true);
    }
  };
    ...
    <>
      <Surface style={styles.screenContainer}>
        <Appbar.Header style={styles.appbar}>
          ...
          />
          <Appbar.Content title="게시글 작성" titleStyle={styles.appbarTitle} />
        </Appbar.Header>
